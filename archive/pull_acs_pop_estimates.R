...
# saveRDS(pop_2015,here("data","acs","county_acs_pop_2015.rds"))
# saveRDS(pop_2019,here("data","acs","county_acs_pop_2019.rds"))
# saveRDS(pop_2024,here("data","acs","county_acs_pop_2024.rds"))